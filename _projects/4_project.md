---
layout: page
title: GO-MYO:Gesture prediction
description: Online Training & Predicting Hand Gestures.
img: assets/img/projects/04_go_myo/01.png
importance: 4
category: Master
---
🏗️ **_Introduction_** | GO MYO: Online Training & Predicting Hand Gestures.

🚀 **_Progressing_** | This project aims to realize real-time hand gestures prediction, which means the GO MYO-embeded model can output target gestures before the completion of signal collection.
...
Reference
% Python bindings for the Myo SDK: @<a href="https://github.com/NiklasRosenstein">NiklasRosenstein</a> | myo-python
