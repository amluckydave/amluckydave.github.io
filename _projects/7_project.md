...
By introducing a projection method, we also redefine fiber alignment in a broader sense. This work is believed to provide a new insight into the nature of gap electrospinning, which will greatly expand the versatility of this technique to create devices for a myriad of applications.


<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/projects/07_meter_fibers/01.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Meter-long Aligned Nanofibers
</div>
...
<div class="caption">
    Schematic illustration of some typical fiber alignment 
</div>
